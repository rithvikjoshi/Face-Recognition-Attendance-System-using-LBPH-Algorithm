...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        # #image3
        # img2=Image.open(r"img\university.jpg")
        ...
        title_lbl=Label(bg_img,text="FACE RECOGNITION LAB ATTENDANCE", font=("time new roman",35,"bold"),bg="white",fg="red")
        ...
        #Train Data
        img7=Image.open(r"img\smart-attendance.jpg")
        ...
        b1_1=Button(bg_img,text="Train Data",cursor="hand2", font=("time new roman",15,"bold"),bg="darkblue",fg="white",command=self.train_data)
        ...
        b1_1=Button(bg_img,text="Face Dectector",cursor="hand2", font=("time new roman",15,"bold"),bg="darkblue",fg="white",command=self.face_data)
        b1_1.place(x=700,y=260,width=220,height=40)

        #Attendance
        img6=Image.open(r"img\girl.jpeg")
        ...
        #Photos
        img8=Image.open(r"img\images.jpg")
